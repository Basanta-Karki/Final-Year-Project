...
//   const [role, setRole] = useState("tutor");  // Set 'tutor' as the default active role
...
//     >
//       <h2 className="text-lg font-semibold text-gray-800 mb-4">Join as a Student</h2>
//       <div>
//         <input
//           type="text"
//           name="firstName"
...
//           className={`flex items-center px-6 py-2 rounded text-lg ${
//             role === "student" ? "bg-blue-600 text-white" : "bg-gray-200 text-gray-800"
//           }`}
//         >
