      ...
      <div className="w-full max-w-2xl bg-white shadow-lg rounded-xl border border-gray-300 relative">
        ...
        <div className="p-5">
          ...
          <div className="border border-gray-300 rounded-lg p-5 flex items-center justify-center text-gray-400 bg-gray-50">
            {documents.length ? (
              <a href={"https://utfs.io/f/"+documents[0]} target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">
                View Document
              </a>
            ) : (
              <>
        ...
        <div className="flex justify-between p-5 bg-gray-100 border-t border-gray-300">
          <button className="w-1/2 bg-green-600 hover:bg-green-700 text-white font-semibold py-2 mr-2 rounded-lg">
            ✅ Accept Tutor
          </button>
          <button className="w-1/2 bg-red-600 hover:bg-red-700 text-white font-semibold py-2 ml-2 rounded-lg">
            ❌ Reject Tutor
          </button>
        </div>
      </div>
